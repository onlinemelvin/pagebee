...
describe("computeCommission", () => {
  ...
  it("uses the per-plan base for each plan", () => {
    ...
    expect(computeCommission({ plan: "HIVE", listedSetupFeeCents: 99900, collectedSetupFeeCents: 99900 }).amount).toBe(185);
  });
  ...
  it("reduces the base proportionally for discounts beyond the allowance", () => {
    // Honey listed $699, collected $599 (rep floor) → $100 off = ~14.31% → keep ~85.69% of $110
    ...
    expect(r.amount).toBe(94.26); // 110 * (1 - 10000/69900)
