...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-2xl border border-dashed border-stone-300 bg-stone-50/60 text-center",
        className,
      )}
    >
      <Honeycomb opacity={0.05} className="text-amber-300" />
      <div className={cn("relative flex flex-col items-center justify-center", compact ? "px-6 py-8" : "px-6 py-14")}>
