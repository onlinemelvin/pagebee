...
// premium-plan cues so CONNECT vs AUTOMATE reads at a glance, never the core nav, badges, or CTAs.
...
// Honey/amber fallback for any plan without a specific accent (e.g. LAUNCH, or unknown names).
...
/** Accent palette for a plan name (LAUNCH/CONNECT/AUTOMATE); falls back to the honey theme. */
